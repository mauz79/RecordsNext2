; RecordsNext 3.1.1 - installer pubblico
...
OutputBaseFilename=RecordsNext_3.1.1_SETUP
...
[Files]
Source: "D:\DEV_APPS\RecordsNext2.0\release\RecordsNext_3.1.1_FULL\payload\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
