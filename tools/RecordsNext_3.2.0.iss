; RecordsNext 3.2.0 - installer pubblico
...
OutputBaseFilename=RecordsNext_3.2.0_SETUP
...
[Files]
Source: "D:\DEV_APPS\RecordsNext2.0\release\RecordsNext_3.2.0_FULL\payload\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    MsgBox(
      ...
      'RecordsNext 3.2 richiede Java 21 o superiore.',
      mbError,
      MB_OK
    );
    exit;
